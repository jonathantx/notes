...
export function NewNoteCard ({onNoteCreated} : NewNoteCardProps) {
    ...
    <Dialog.Root>
        ...
        <Dialog.Portal> 
            ...
            <Dialog.Content className="fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full bg-slate-700 md:h-[60vh] md:rounded-md flex flex-col outline-none">
